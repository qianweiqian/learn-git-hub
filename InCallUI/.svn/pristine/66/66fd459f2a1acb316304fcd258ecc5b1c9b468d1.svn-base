...
public class DialpadFragment extends BaseFragment<DialpadPresenter, DialpadPresenter.DialpadUi>
    ...
    final CallCardPresenter mCallCardPresenter = new CallCardPresenter(); 
    // END BOWAY, xiao.shen
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View parent = inflater.inflate(InCallActivity.isSimpleSystem ? com.android.incallui.R.layout.dtmf_twelve_key_dialer_view2 :
        ...
        // BEGIN BOWAY, xiao.shen, 20151019, modify InCall UI.
        mDialpadView.setBackgroundResource(R.color.incall_dialpad_background1);
        // END BOWAY, xiao.shen
    ...
    public void onResume() {
        ...
        updateColors();
        // BEGIN BOWAY, xiao.shen, 20151019, modify InCall UI.
        onEndCallAndHideKeypad();
        // END BOWAY, xiao.shen
    }
    
    // BEGIN BOWAY, xiao.shen, 20151116, modify Dialpad number text color.
    public void updateColors() {
        ...
        for (int i = 0; i < mButtonIds.length; i++) {
            ...
            if (InCallActivity.isSimpleSystem) {
            	((TextView) dialpadKey.findViewById(R.id.dialpad_key_number)).setTextColor(getResources().getColor(R.color.keypad_number_text_color_simple));
			}else {
				((TextView) dialpadKey.findViewById(R.id.dialpad_key_number)).setTextColor(getResources().getColor(R.color.keypad_number_text_color));
			}      
        }
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        mCallCardPresenter.init(getActivity(), call);
    }
    
    private void onEndCallAndHideKeypad() {
        TextView mButtonEndCall, mButtonHideKeypad;
        mButtonEndCall = (TextView) mDialpadView.findViewById(R.id.endcall);
        mButtonHideKeypad = (TextView) mDialpadView.findViewById(R.id.hidekeypad);
        mButtonHideKeypad.setText(getResources().getString(R.string.hide_keypad));
        mButtonHideKeypad.setTextColor(getResources().getColor(R.color.hide_keypad_text_color));
        mButtonEndCall.setOnClickListener(new View.OnClickListener() {
        
        @Override
            public void onClick(View v) {
                // TODO Auto-generated method stub
                mCallCardPresenter.endCallClicked();
                ((InCallActivity) getActivity()).hideDiapad(); 
            }
        });
       
        mButtonHideKeypad.setOnClickListener(new View.OnClickListener() {
