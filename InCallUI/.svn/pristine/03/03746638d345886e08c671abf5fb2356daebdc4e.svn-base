...
public class CallCardPresenter extends Presenter<CallCardPresenter.CallCardUi>
    ...
    public void onStateChange(InCallState oldState, InCallState newState, CallList callList) {
        ...
        if (newState == InCallState.INCOMING) {
            ...
            ui.showCallButtonsFragment(false);
            if (InCallActivity.isSimpleSystem) {
                ui.showIncomingCallBanner(true);
            }
            ...
            // BEGIN BOWAY, yulong.tan, 20150507, InCall UI.
            if (InCallActivity.isSimpleSystem) {
                ui.showIncomingCallBanner(false);
            }
            // END BOWAY, yulong.tan
        ...
        if ((mPrimary!=null ? mPrimary.getState() != Call.State.INCOMING : true)
                && (mSecondary!=null ? mSecondary.getState() != Call.State.INCOMING : true)
                && (mThird!=null ? mThird.getState() != Call.State.INCOMING : true)
                && newState != InCallState.NO_CALLS) {
            getUi().showCallButtonArea(true);
        } else {
            getUi().showCallButtonArea(false);
        }
        // END BOWAY, yulong.tan
        ...
        if (mPrimary != null) {
            ...
            ui.setSimIndicator(SubscriptionManager.getSlotId(mPrimary.getSubId()));
            // END BOWAY, yulong.tan
        } else {
            getUi().setCallState(
                    callState,
    ...
    */
    ...
    private void updatePrimaryDisplayInfo() {
        ...
        if (mPrimary == null) {
            ...
            ui.setPrimary(null, null, false, null, null, false, null);
            return;
        }
    ...
    public interface CallCardUi extends Ui {
        ...
        */
        ...
        /// @}
        // BEGIN BOWAY, yulong.tan, 20150505, InCall UI.
        void setSimIndicator(int slotId);
        void showCallButtonsFragment(boolean isShow);
        void setLocation(String location);
        void showIncomingCallBanner(boolean isShow);
        // END BOWAY, yulong.tan
        // BEGIN BOWAY, yulong.tan, 20150630, InCall UI.
        void showCallButtonArea(boolean isShow);
        // END BOWAY, yulong.tan
    }
    ...
    private void setPrimaryForIncomingVolteConference() {
        if (mPrimaryContactInfo == null) {
            ...
            getUi().setPrimary(null, null, false, null, null, false, null);    // BEGIN BOWAY, yulong.tan, 20150707, InCall UI.
            return;
        }
        String name = getNameForCall(mPrimaryContactInfo);
        String number = getNumberForCall(mPrimaryContactInfo);
        ...
        getUi().setPrimary(
                ...
                getConferencePhoto(mPrimary),
                false/*isSip*/,
                null);    // BEGIN BOWAY, yulong.tan, 20150707, InCall UI.
    }
    ...
    public void windowUpdateProximitySensorMode(){
            InCallPresenter.getInstance().windowUpdateProximitySensorMode();
    }    
