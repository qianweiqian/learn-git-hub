...
public class GeneralSettingsFragment extends PreferenceFragment
  ...
  //qianweiqiang boway show location choice
    private static final String BUTTON_SHOW_LOCATION  = "button_show_incoming_location"; 
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //qianweiqiang boway show location choice
        mShowLocation = (CheckBoxPreference) findPreference(BUTTON_SHOW_LOCATION);
        //end
        ...
        //qianweiqiang boway show location choice hide 2015 7 15
        soundCategory.removePreference(mShowLocation); 
        mShowLocation = null;
        //qianweiqiang boway show location choice hide 2015 7 15
      ...
      //qianweiqiang boway show location choice 
       ...
       if(mShowLocation != null)
        {
            mShowLocation.setOnPreferenceChangeListener(this);
            final SharedPreferences prefs = mContext.getSharedPreferences(
                    DialtactsActivity.SHARED_PREFS_NAME, Context.MODE_WORLD_READABLE);
    //qianweiqiang 2015 7 4 set default false
            Boolean isOpen = prefs.getBoolean("IS_SHOW", false);
            mShowLocation.setChecked(isOpen); 
        }
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        ...
        } else if(preference == mShowLocation)
        {
            ...
            boolean showLocation = mShowLocation.isChecked();
            Editor edit= prefs.edit();
            Boolean isOpen = showLocation;
            edit.putBoolean("IS_SHOW", isOpen);
            edit.commit();     
        }
        return true;
    }
