...
public final class CallLogListItemViews {
    ...
    //qianweiqiang add TextView Date 2015 5 20
    public TextView mDateCallLog;
    public TextView mDateCallLogFirst;
    public TextView mSmsAction;
    //
    /** @} */
    ...
    private CallLogListItemViews(QuickContactBadge quickContactView, View primaryActionView,
            ...
            TextView dayGroupHeader, TextView mDateCallLog, TextView mDateCallLogFirst) {
        ...
        //qianweiqiang add 
        this.mDateCallLog = mDateCallLog;
        this.mDateCallLogFirst = mDateCallLogFirst;
        //end
    }
    ...
    public static CallLogListItemViews fromView(View view) {
        return new CallLogListItemViews(
                ...
                ,(TextView) view.findViewById(R.id.calllog_date),
                (TextView) view.findViewById(R.id.calllog_date_first)
                );
    }
    ...
    public static CallLogListItemViews createForTest(Context context) {
        ...
        //qianweiqiang add sms
        views.mSmsAction = new TextView(context);
        //end
